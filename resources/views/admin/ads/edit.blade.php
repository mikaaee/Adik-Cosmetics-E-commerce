...
@section('content')
    ...
    <div class="edit-ad-wrapper">
        ...
        <form action="{{ route('admin.ads.update', $ad['id']) }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 15px;">
                <label>
                    <input type="radio" name="image_type" value="url" onchange="toggleImageInput()" checked>
                    Use Image URL
                </label><br>
                <label>
                    <input type="radio" name="image_type" value="file" onchange="toggleImageInput()">
                    Upload Image File
                </label>
            </div>
            ...
            <div id="urlInput">
                ...
                <input type="text" name="image_url" class="form-control" value="{{ $ad['image_url'] }}">
                <img id="previewUrl" src="{{ $ad['image_url'] }}" alt="Current Ad Image" class="preview-img"
                    style="display: block;">
            </div>
            ...
            <div id="fileInput" style="display: none;">
                ...
                <img id="previewImage" src="#" alt="New Image Preview" class="preview-img">
            </div>
    ...
    <script>
        function toggleImageInput() {
            ...
            document.getElementById('previewUrl').style.display = (type === 'url') ? 'block' : 'none';
